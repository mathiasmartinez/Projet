...
urlpatterns = [
    ...
    path('project/<int:ident>/', views.projet), # Affichage des tâches d'un projet
    path('task/<int:ide>/',views.tache,name='task'), # Affichage des attributs d'une tâche
    path('newtask/',views.newtask), # Création d'une nouvelle tâche
    path('edittask/<int:ide>/',views.edittask), # Modification d'une tâche
